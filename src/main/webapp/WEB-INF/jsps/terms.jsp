...
<html lang="en">
  ...
  <body>
    <div class="wrapper">
      ...
      <main class="main">
        <div class="main__title">Terms & Conditions</div>
        ...
        <div class="main__login-container">
          <p class="terms">
            ...
            are the terms and conditions or "Terms" that govern your use of any website that links to these Terms (the "Site"). By using or visiting the Site, you expressly agree to be bound by these Terms and all applicable laws and regulations governing the Site. ASPENCORE, our parent, and its subsidiaries and/or affiliates (collectively, "we", "us", or "our") reserve the right to change these Terms at any time, effective immediately upon posting or linking on the Site. If you violate these Terms, we may terminate your use of the Site, bar you from future use of the Site, and/or take appropriate legal action against you.
          </p>
          ...
          <p class="terms">
            ...
            the Site to search for or link to another site, you agree and understand that you may not make any claim against us for any damages or losses whatsoever resulting from your use of the Site to obtain search results or to link to another site.
          </p>
